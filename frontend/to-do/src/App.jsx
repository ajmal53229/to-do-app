...
const App = () => {
  ...
  const auth_check = async () =>{
      try {
      const res =await axios.get("http://to-do-app-production-a39a.up.railway.app/Check_auth", {
    ...
    const fetchTasks =async ()=>{
      try {
  const res = await axios.get("http://to-do-app-production-a39a.up.railway.app/Data",
    {
    withCredentials: true
  }
  )
